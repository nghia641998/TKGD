        ...
        return (
             <>
                <div id='Home___Select_template___1' className="row mx-auto">
                    <svg className="header_view1">
                        <pattern elementId="header_view1_A11_Rectangle_2" 
                            id="header_view1_A11_Rectangle_2_pattern" 
                            x="0" 
                            y="0" 
                            width="100%"
                            height="100%">
                            <image x="0" 
                                ...
                                width="100%" 
                                height="100%" 
                                href="/img/header_view1_A11_Rectangle_2_pattern.png" 
                                xlinkHref="/img/header_view1_A11_Rectangle_2_pattern.png"/>
                        </pattern>
                        <rect fill="url(#header_view1_A11_Rectangle_2_pattern)" 
                            id="header_view1" 
                            rx="0" 
                            ry="0" 
                            x="0" 
                    ...
                    <div id="Component_5___2" 
                        className="Component_5___2">
                        ...
                        <div id="Component_2___1" 
                            className="Component_2___1">
                            ...
                            <svg className="ic_search_24px" 
                                viewBox="3 3 28.582 29.475">
                                <path fill="rgba(164,164,164,1)" 
                                    id="ic_search_24px" 
